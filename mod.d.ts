...
/**
* Interface for iterators of pseudorandom numbers drawn from a negative binomial distribution.
*/
...
* // ...
*/
declare function iterator( r: number, p: number, options?: Options ): Iterator<number>;
